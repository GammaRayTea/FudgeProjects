...
namespace Script {
    ...
    export class RandomCars extends ƒ.ComponentScript {
        // Register the script as component for use in the editor via drag&drop
        public static readonly iSubclass: number = ƒ.Component.registerSubclass(RandomCars);
        // Properties may be mutated by users in the editor via the automatically created user interface
        public message: string = "RandomCars added to ";
        ...
        public spawnRandomCars = async (): Promise<void> => {
